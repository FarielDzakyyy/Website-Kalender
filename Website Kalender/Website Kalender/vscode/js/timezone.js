...
function CitiesObject(place, offset, selisih) {
   this.place = place;
   this.offset = offset;
   this.selisih = selisih;
   this.showTime = function (key) {
      let Interval = setInterval(() => {
         let timezone = getTimezone(this.offset);
...
const DataTimezone = {
   ...
   bandarseribegawan: new CitiesObject('Bandar Seri Begawan, Brunei Darussalam', 8, '+08.00'),
